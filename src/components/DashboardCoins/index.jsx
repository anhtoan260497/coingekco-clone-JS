...
const columns = [
  ...
  },
  {
    ...
    dataIndex: "coinLabel",
    sorter: (a, b) =>
      a.name.charCodeAt(0) - b.name.charCodeAt(0) < 0 ? true : false,
  ...
  },
  {
    ...
    dataIndex: "price",
    sorter: (a, b) =>
      parseInt(a.price.slice(1, a.price.length)) -
        parseInt(b.price.slice(1, a.price.length)) <
      0
        ? true
        : false,
  ...
  },
  {
    ...
    sorter: (a, b) =>
      a.percentHour.slice(0, a.percentHour.length - 1) -
        b.percentHour.slice(0, b.percentHour.length - 1) <
      0
        ? true
        : false,
    className: "text-right ",
  },
  {
    ...
    sorter: (a, b) =>
      a.percentDay.slice(0, a.percentDay.length - 1) -
        b.percentDay.slice(0, b.percentDay.length - 1) <
      0
        ? true
        : false,
    className: "text-right ",
  },
  {
    ...
    sorter: (a, b) =>
      a.percentWeek.slice(0, a.percentWeek.length - 1) -
        b.percentWeek.slice(0, b.percentWeek.length - 1) <
      0
        ? true
        : false,
    className: "text-right ",
  },
  {
    ...
    dataIndex: "24hVol",
    sorter: (a, b) =>
      parseInt(a["24hVol"].slice(1, a["24hVol"].length)) -
        parseInt(b["24hVol"].slice(1, a["24hVol"].length)) <
      0
        ? true
        : false,
  },

  {
    ...
    dataIndex: "marketCap",
    sorter: (a, b) =>
      parseInt(a.marketCap.slice(1, a.marketCap.length)) -
        parseInt(b.marketCap.slice(1, a.marketCap.length)) <
      0
        ? true
        : false,
    className: "text-right ",
    ...
    const getData = async () => {
      try {
        ...
        const dataList = result.map((item, key) => ({
          ...
          number: key + 1,
          key: (
            <div className="flex items-center gap-1 font-bold" key={key}>
              {key + 1}
            </div>
          ),
          coinLabel: (
            <div className="flex items-center gap-2 font-bold" key={key}>
              <img className="coin-icon" src={item.image} />
          ...
          percentHour: `${item.price_change_percentage_1h_in_currency.toFixed(
            1
          )}%`,
          percentDay: `${item.price_change_percentage_24h_in_currency.toFixed(
            1
          )}%`,
          percentWeek: `${item.price_change_percentage_7d_in_currency.toFixed(
            1
          )}%`,
          percentHourDisplay: (
            <p
          ...
          marketCap: (
            <p className="text-right number-display text-light">
